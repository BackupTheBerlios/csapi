...
The path environment variable should contain the \ccmhome{}\verb!/bin!, \cshome{}\verb!/cs_app/! and \vdehome{} XXX entries. This is not required, but be warned that all executables are assumed to be in the path for the examples provided.
