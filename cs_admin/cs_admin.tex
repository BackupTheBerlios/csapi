...
An alternative version for \cs{} 4.4 is also furnished on the homepage of the project\footnote{\href{http://csapi.berlios.de/cs\_admin/}{csapi.berlios.de/cs\_admin/}}.
...
A trigger script is provided in appendix \ref{sec:reset_attribute.pl} as an example for attribute triggers. On \verb!project_name! modification, it check the new value of the attribute and eventually modify it (\emph{i.e.} according to some checks).
