...
/**
 * <p>
 * The job class for the Query Selected command in the ShowReportView menu.
 * </p>
 * 
 * <p>
 * It retrieves through an asyncExec session the selection from the viewer of
 * ShowReportView, build a query and re-run the report with same attributes. If
 * the report is successfull, the viewer is updated and the view refreshed.
 * </p>
 * 
            ...
            public void run() {
                try {
                    ...
                    if (inst != null) {
                         ...
                         */
                        StructuredSelection mySel = (StructuredSelection) ((ShowReportView) inst)
                        ...
                        final String attributes = (String) JOptionPane
                                .showInputDialog(
                                        null,
                                        "Please provide attributes list, separated by pipes:",
                                        "Attributes needed",
                                        JOptionPane.OK_CANCEL_OPTION, null,
                                        null, "problem_number|problem_synopsis");
                        // if cancel is hit
                        if (attributes == null) {
                            return;
                        }
