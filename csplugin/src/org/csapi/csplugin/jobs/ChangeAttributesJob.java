    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        Display.getDefault().asyncExec(new Runnable() {
            public void run() {
                ...
                final String attributesList = (String) JOptionPane
                        .showInputDialog(
                                null,
                ...
                try {
                    ...
                    /*
                     * Get the instance of the view and focus it. Set the new
                     * columns (they have changed) and set the new report as
                     * viewer.
                     */
