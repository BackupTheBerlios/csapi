...
/**
 * <p>
 * The job class for the Refresh Report command in the ShowReport view.
 * </p>
 * 
 * <p>
 * It retrieves the viewer (Report) from ShowReportView, and re-run it with same
 * query and attributes. If the execution is successfull, then it updates the
 * viewer and refreshes the view.
 * </p>
 * 
    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        Display.getDefault().asyncExec(new Runnable() {
            public void run() {
                ...
                Report report = new Report("Empty Query", null);
                ...
                try {
                    report = sessionMgr.getReport(report.getQuery(), report.getAttributesString());
        ...
        return new Status(Status.OK, "CSPlugin", 0, "Refresh was successfull.",
                null);
    }
