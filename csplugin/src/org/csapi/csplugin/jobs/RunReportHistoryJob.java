...
/**
 * <p>
 * The job class for the Run Report command in the MyReports view.
 * </p>
 * 
 * <p>
 * It retrieves the selection (Report) from ReportHistoryView, and re-run it
 * with same query and attributes. If the execution is successfull, then it
 * updates the viewer of ShowReportView and refreshes the ShowReportView view.
 * The asyncExec session allows to access the visual thread, which is actually
 * out of scope for the current thread.
 * </p>
 * 
        ...
        Display.getDefault().asyncExec(new Runnable() {
            public void run() {
                try {
                     ...
                     * view of ShowReportView. XXX VERIFY
                     */
                    if (instMyReports != null && instShowReport != null) {
                        ...
                        try {
                            ...
                            ((ShowReportView) instShowReport).setColumns(report
                                    .getAttributes());
