...
/**
 * <p>
 * XML provider utility for SessionMgr.
 * </p>
 * 
 * <p>
 * SessionMgr provides a set of static methods to get XML-enrobed Strings for
 * communications with the server. Basically, a request is modeled after this
 * structure:
 * </p>
 * <ol>
 ...
 * <li>Action Flag: a keyword to state reason of request (either login, report,
 * transition, etc.).</li>
...
public class XMLProvider {
    ...
    /**
     * Constructor. Since all methods are static, should not be called -- thus
    ...
    /**
     * Static method to get XML-enrobed 'data_report' value of the action_flag
     * tag. Value passed as parameter is assumed to be already URL-encoded
     * 
    ...
    /**
     * Static method to get XML-enrobed value for a provided csapi_token value.
     * 
     * @param csapiToken
     *            The csapi_token to be used when sending the request (ensures
    ...
    /**
     * Static method to get XML-enrobed value for a provided csapi_role value.
     * 
     * @param csapiRole
     *            The CS Role to be used for login.
     ...
     * 
     * @param csapiDatabase
     *            The path to the database to be used on the server.
    ...
    /**
     * Static method to get XML-enrobed value for csapi_encoded_password value.
     * This method is only used on login.
     * 
     * @param csapiEncodedPassword
     *            The csapiEncodedPassword value to be used.
    ...
    /**
     * Static method to get XML-enrobed value for a provided csapi_user value.
     * This method is only used on login.
     * 
     * @param csapiUser
     *            The User to be used for login.
    ...
    /**
     * Static method to get XML-enrobed value for a provided query string value.
     * This method is used when requesting a report. Value passed as parameter
     * is assumed to be already URL-encoded.
     * 
     * @param csapiRole
     *            The queryString to be used for the report.
     * @return Returns the csapiRole enrobed with XML.
     */
    public static String getXMLQueryString(String queryString) {
        String myXML = "";
        myXML += "%3Ccsapi_query_string%3E" + queryString
                + "%3C%2Fcsapi_query_string%3E";
        return myXML;
    }

    /**
     * Static method to get XML-enrobed value for a provided reportTitle value.
     * This method is used when requesting a report. Value passed as parameter
     * is assumed to be already URL-encoded.
     * 
     * @param reportTitle
    ...
    public static String getXMLAttributeList(String attributeList) {
        String myXML = "";
        myXML += "%3Ccsapi_attribute_list%3E" + attributeList
                + "%3C%2Fcsapi_attribute_list%3E";
        return myXML;
    }
}
